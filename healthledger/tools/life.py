...
def analyze_reproductive_trend(user: str | None = None, limit: int = 24) -> dict:
    ...
    return _envelope(
        ...
        source_ids=_source_refs(rows, table="reproductive_records"),
        user=u,
...
def analyze_substance_trend(
    ...
    return _envelope(
        ...
        source_ids=_source_refs(rows, table="substance_use_logs"),
        user=u,
        substance=clean_substance,
        count=len(rows),
...
def analyze_wearable_trend(
    ...
    return _envelope(
        ...
        unit=latest["unit"],
        days_stale=latest_days_stale,
        source_ids=_source_refs(rows, table="wearable_samples"),
        user=u,
