...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "immunizations, care_gap_report for missing or stale stored data, and "
        "build_clinician_packet for source-cited visit prep.\n"
        ...
        "logs. Call get_reasoning_guide once per session before cross-signal reasoning; "
        "it is not optional context, it is load-bearing. Association is not causation, "
        "and none of it is diagnosis.\n"
        ...
        "specific rows — the analysis tools return source_ids as table/id citations "
        "plus the latest value's recency, and get_record(table, id) fetches the exact "
        "cited row.\n\n"
